...
document.querySelector('body').addEventListener('submit', e=>{
  if (e.target == document.querySelector('form.Cart') && !document.querySelector('input#agree').checked){
    e.preventDefault();
    document.querySelector('p#termsalert').style.display = 'block';
    setTimeout(()=>{
      document.querySelector('p#termsalert').removeAttribute('style');
    }, 2000);
  }
});
